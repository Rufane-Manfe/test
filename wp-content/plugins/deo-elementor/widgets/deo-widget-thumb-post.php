...
class Deo_Widget_Thumb_Post extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Deo Thumb Post', 'deo-elementor' );
	}
	...
	private function section_grid() {
		...
		$this->add_control(
			...
			[
				...
				'placeholder' => __( '1', 'deo-elementor' ),
				'default'     => 1,
			]
		);
	...
	protected function renderImage() {
		...
		if ( has_post_thumbnail() ) { ?>
			<div class="thumb-container">
				...
				<?php
				if ( has_post_thumbnail() ) :
					the_post_thumbnail( 'neotech-thumb-single-post' );
				endif; ?>
			</div>
		<?php
		}
